...
public class BoundedServiceActivity extends Activity {
	...
	private GetMessageFromServiceListener getMessageFromServiceListener = new GetMessageFromServiceListener();
    
    private class GetMessageFromServiceListener implements View.OnClickListener {
		@Override
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        getMessageFromServiceButton.setOnClickListener(getMessageFromServiceListener);
	}
